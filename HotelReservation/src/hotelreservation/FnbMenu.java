 ...
 * @author Sandusha
 */
public class FnbMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Villa Nilnara - F&B Manager");
        ...
        jPanel1.add(btnInlist5, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 220, 300, 60));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/screen.jpg"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1620, 820));
...
ViewInHouseList obj = new ViewInHouseList();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FnbMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
