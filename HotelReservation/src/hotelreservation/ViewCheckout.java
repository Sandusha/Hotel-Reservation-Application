...
Connection con;
    ...
    private void initComponents() {
        ...
        tblInhouse.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Reservation ID", "Customer name", "NIC", "Phone", "Email", "Ckeckin Date", "Checkout Date", "Room number", "Room price", "Meal Price", "Days stayed", "Extra", "Total Amount"
            }
        ) {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        {
         tblInhouse.setModel(new DefaultTableModel(null,new String[]{"RID","Customer_Name","NIC","Phone","Email",
             "Checkin","Checkout","Room_number","Room_price","Meal_Price","Days_stayed","Extra","Total_amount"})) ;
        
            PreparedStatement stmt = con.prepareStatement("select RID,Customer_Name,NIC,Phone,Email,CheckIn,CheckOut,RoomNumber,RoomPrice,MealPrice,DaysStayed,Extra,TotalAmount from CheckOuts");
            ...
            while (rs.next())
            {
                ...
                String Total_amount = String.valueOf(rs.getString("TotalAmount"));
                
                String tbData[] = {RID,Customer_Name,NIC,Phone,Email,
             Checkin,Checkout,Room_number,Room_Price,Meal_Price,Days_stayed,Extra,Total_amount}; 
